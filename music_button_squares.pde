...
void setup() {
  ...
  ffY = pauseY1;
  //
  rrX = pauseX1 - ( buttonPositionCulumn*buttonReferentMeasure );
  rrY = pauseY1;
  //
...
void draw() {
  ...
  */
  ...
  //ellipse( loop1X, loop1Y, loop1WidthDiameter, loopHeightDiameter );
  //ellipse( loop1X, loop1Y, loopWidthDiameter, loopHeightDiameter );
