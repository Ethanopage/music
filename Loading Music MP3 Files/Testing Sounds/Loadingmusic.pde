...
void setup() {
  ...
  //
  minim = new Minim(this); //load from data directory, loadFile should also load project folder, like loadImage 
  //
  //Building Global Variables from Local Variables, some imformation does not need to be remembered 
  ...
  soundEffect1 = minim.ladFile( soundEffectPathway + fslash + The_Simplest_Sting + dereferencer + filerExtension );
  //
